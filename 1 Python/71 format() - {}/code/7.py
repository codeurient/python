...
# bu spesifikator deyerlerin sonuna bosluq qoyur

# Ferqli yaziliw qaydalari sizi casdirmasin. Bezi kodlarin yazilis qaydalari ferqli olsada
...
print("Salam menim adim {0:{1}}-dir".format(ad, '10'))  # bele de yazmaq olar