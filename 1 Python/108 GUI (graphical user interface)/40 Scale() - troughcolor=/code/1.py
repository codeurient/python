...
istiSekil = PhotoImage(file='lessons/108 GUI (graphical user interface)/40 Scale() - troughcolor=/code/isti.png')
...
soyuqSekil = PhotoImage(file='lessons/108 GUI (graphical user interface)/40 Scale() - troughcolor=/code/soyuq.png')
