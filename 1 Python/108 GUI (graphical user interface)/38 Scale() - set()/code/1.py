...
skala = Scale( pencere, from_=769, to=0, length=600, orient=VERTICAL, tickinterval=10, resolution=5)
#! 1) set() -  metodu ile şkalanın başlanğıcda dəyəri nə olsun təyin edirik.
# Gosterici 100 ile 0 arasinda olarsa ve biz proqramı işə saldıqda şkalanın göstəricisinin həmişə tam mərkəzdən 
